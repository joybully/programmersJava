...
public class BoardDAO {
    ...
    public ArrayList<BoardTO> boardList(){
        System.out.println("boardList called");
    ...
    public BoardTO boardView(BoardTO to){
        System.out.println("boardView called");
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
    ...
    public int boardWriteOk(BoardTO to){
        System.out.println("boardWriteOk called");
        Connection conn = null;
        PreparedStatement pstmt = null;
        int flag = 1;
        try {
    ...
    public BoardTO boardModify(BoardTO to){
        System.out.println("boardModify called");
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
    ...
    public int boardModifyOk(BoardTO to){
        System.out.println("boardModifyOk called");
        Connection conn = null;
        PreparedStatement pstmt = null;
    ...
    public BoardTO boardDelete(BoardTO to){
        System.out.println("boardDelete called");
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
    ...
    public int boardDeleteOk(BoardTO to){
        System.out.println("boardDeleteOk called");
        Connection conn = null;
        PreparedStatement pstmt = null;
