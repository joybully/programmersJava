...
<%
	...
	for(BoardTO to: lists){
		...
		if(wgap==0){
			sbHtml.append("<td class='left'><a href='./controller?path=view&seq="+seq+"'>"+subject+"</a>&nbsp;<img src='./images/icon_new.gif' alt='NEW'></td>");
		} else{
			sbHtml.append("<td class='left'><a href='./controller?path=view&seq="+seq+"'>"+subject+"</a></td>");
		}
